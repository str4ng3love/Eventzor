...
export default function layout({ children }: { children: React.ReactNode }) {
  ...
  const handleSetRange = (e: React.MouseEvent) => {
    ...
    router.push(
      `/events/${selected?.toLowerCase().replace(" ", "-")}` +
        "?" +
        searchParams,
    );
  };
          ...
          <div className="grid w-fit grid-cols-2 justify-center gap-2 sm:grid-cols-3 lg:grid-cols-6">
            <Button
              ...
              fn={(e) => {
                ...
                router.push("/events/all-items" + "?" + searchParams, {});
              }}
              bgColor="bg-link"
            />
            <Button
              ...
              fn={(e) => {
                ...
                router.push("/events/popular" + "?" + searchParams, {});
              }}
              bgColor="bg-link"
            />
            <Button
              ...
              fn={(e) => {
                ...
                router.push("/events/most-liked" + "?" + searchParams, {});
              }}
              bgColor="bg-link"
            />
            <Button
              ...
              fn={(e) => {
                ...
                router.push("/events/upcoming" + "?" + searchParams, {});
              }}
              bgColor="bg-link"
            />
            <Button
              ...
              fn={(e) => {
                ...
                router.push("/events/sales-ending" + "?" + searchParams, {});
              }}
              bgColor="bg-link"
            />
