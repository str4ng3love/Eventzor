    ...
    return (
        <>
            <div className="w-[80%] mt-20">
                <Heading1 text="users" />
                <div className="bg-black/20 p-8 dark:shadow-none shadow-lg dark:ring-2 ring-primary rounded-md grid gap-2 xl:grid-cols-8 lg:grid-cols-6 md:grid-cols-4 sm:grid-cols-3 mb-10">
