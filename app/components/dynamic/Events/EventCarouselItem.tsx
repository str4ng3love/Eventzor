...
const EventCarouselItem = ({ item, currency }: Props) => {
    ...
    return (
        ...
        <div className="flex ring-2 ring-primary bg-black h-[20rem] transition-all duration-150">
            ...
            <div className={`hidden  bg-gradient-to-br from-primary to-slate-900 lg:flex flex-col justify-between p-1`}>
                <h3 className="p-2 first-letter:uppercase font-bold text-xl grow-[1]">
                    {item.title}
                </h3>


                <div className="shrink-0 text-sm flex flex-col justify-between">
                    <span className="p-1">
