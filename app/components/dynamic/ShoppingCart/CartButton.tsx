    ...
    <>
      {newEntries === 0 ? (
        ...
        <button
          ...
          onClick={(e) => fn(e)}
        >
          <span className="absolute bg-secondary flex items-center justify-center rounded-full h-86 w-6 top-0 right-0 -translate-y-[0.5rem] translate-x-[1rem] text-white">
            {newEntries}
          </span>
          <Icon size={size} />
        </button>
