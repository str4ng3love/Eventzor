...
const Comments = async ({ eventId, itemId }: Props) => {
  ...
  return (
    <div className="my-8 flex w-[85%] justify-between">
      <div className="w-full  bg-black/20 p-2 shadow-lg dark:shadow-none">
        <AddComment
          title="Add a comment"
          type={eventId ? CommentType.event : CommentType.item}
          id={itemId ? (itemId as string) : (eventId as string)}
        />
